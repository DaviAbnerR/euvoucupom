...
class Usuario(db.Model):
    ...
    mercado_pago_user_id = db.Column(db.String(50), nullable=True)
    mercado_pago_access_token = db.Column(db.String(255), nullable=True)
...
class Pedido(db.Model):
    ...
    external_reference = db.Column(db.String(100), nullable=True)  # Identificador para conciliação
    itens_json = db.Column(db.Text)  # Salva o carrinho/itens em JSON
    carrinho_limpo = db.Column(db.Boolean, default=False)